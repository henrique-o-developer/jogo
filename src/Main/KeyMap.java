...
public class KeyMap {
    ...
    public <T> Success set(String k, T v) {
        ...
        return s ? new Success("settingKey") : new KeyError("cannot set no existing key");
    }
    ...
    private class man {
        ...
        public <T> KeyMap add(String k, T v) {
            boolean e = false;
        ...
        public <T> KeyMap set(String k, T v) {
            for (int i = 0; i < values.size(); i++) {
                Value va = values.get(i);
    ...
    private class KeyError extends Errors.Error {
